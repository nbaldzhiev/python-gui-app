...
class DocumentMetadataView(wx.Frame):
    ...
    def __init__(self, parent, name):
        super().__init__(parent=parent, name=name, title="Document Metadata")
        self.metadata = {}

        self.main_sizer = wx.BoxSizer(wx.VERTICAL)

        self.checkbox = wx.CheckBox(self, label="Enable", style=wx.CHK_2STATE)
        self.list_ctrl = EditableListCtrl(self, size=(-1, 150), style=wx.LC_REPORT)
        self.save_button = wx.Button(self, label="Save", name="document_save_btn")
